...
## 7. 标题从最强内容点开始，与封面一起生成

标题流程先通读完整材料，寻找最有记忆、拉力与画面的强事实、数字、冲突、人物关系和判断。它们可以只来自整期的一段，不承担全文概括；关键是核心观众会产生一个重要且清楚的问题，视频也能给出足够兑现。候选从第一轮就是标题 × 封面组合，brief 同时记录内容证据、视觉关系、兑现位置与开头衔接。

频道默认核心受众关心科技、进步、AI 与个人成长，很多人在科技公司工作，高管、学生和创业者是自然延伸；嘉宾的职业不自动成为投放人群。人物身份、公司与数字既可能是证据，也可能本身构成最强异常。challenger 会重新阅读材料，以冷启动的一秒理解、十分钟记忆、核心受众拉力、缩略图视觉和内容兑现推翻平庸概括。`看前 → 看后` 只保留为兑现校验，不再统领选题。
